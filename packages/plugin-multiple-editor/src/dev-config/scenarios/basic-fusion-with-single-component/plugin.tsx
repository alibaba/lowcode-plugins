    ...
    return {
      ...
      async init() {
        ...
        project.openDocument(
          getProjectSchemaFromLocalStorage('basic-fusion-with-single-component')
    ...
    return {
      ...
      async init() {
        ...
        skeleton.add({
          ...
          content: (
            <Button
              onClick={() => saveSchema('basic-fusion-with-single-component')}
            >
              保存到本地
            </Button>
          ),
        ...
        skeleton.add({
          ...
          content: (
            <Button
              onClick={() => resetSchema('basic-fusion-with-single-component')}
            >
              重置页面
            </Button>
          ),
      ...
      async init() {
        ...
        skeleton.add({
          ...
          content: (
            <Button
              type="primary"
              onClick={() => preview('basic-fusion-with-single-component')}
            >
              预览
            </Button>
          ),
