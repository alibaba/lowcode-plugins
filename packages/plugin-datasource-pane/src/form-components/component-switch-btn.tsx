...
class ComponentSwitchBtnCompComp extends PureComponent<ComponentSwitchBtnCompProps, ComponentSwitchBtnCompState> {
...
export const ComponentSwitchBtn = connect(ComponentSwitchBtnCompComp, mapProps(
  (props, field) => {
    return {
